...
export default function GeneratorTabs({ onBack, onProfile, initialData, darkMode, toggleTheme }: GeneratorTabsProps) {
  ...
  return (
    <>
      {/* Fixed Header */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-slate-50/90 dark:bg-slate-800/90 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-700/50 shadow-sm">
